...
main_menu = {
    '/help': 'Это бот-парсер "Эки дос". При помощи него вы можете собрать информацию о средней рыночной стоимости авто в Бишкеке.',
    '/support': 'В случае возникновения вопросов обращайтесь по номеру 0777777777',
    '/contacts': 'Кыргызстан, г.Бишкек, Белый дом\nили\nКыргызстан, г.Бишкек, ГКНБ КР',
    '/payments': 'Реквизиты: M-bank 0777777777\nBalanceKG 0777777777'
}
